...
%%change by lcf  function xp = l1eq_pd(x0, A, At, b, pdtol, pdmaxiter, cgtol, cgmaxiter)
function xp = l1eq_pd(x0, A, b, pdtol, pdmaxiter, cgtol, cgmaxiter)
...
if (nargin < 5 - change), pdtol = 1e-3;  end
if (nargin < 6 - change), pdmaxiter = 50;  end
if (nargin < 7 - change), cgtol = 1e-8;  end
if (nargin < 8 - change), cgmaxiter = 200;  end
